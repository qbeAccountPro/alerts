 ...
 * fields.
 */
public class FloodDao extends StdSerializer<FloodAlertByHousehold> {

    public FloodDao(Class<FloodAlertByHousehold> t) {
        super(t);
    }
     ...
     *
     * @param flood    The FloodAddress object to be serialized.
